...
-- B	=>  Location: PIN_W13,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF SystemX IS
...
\U7|F~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \U7|F~0_combout\ = (!\C~input_o\ & ((\B~input_o\) # (!\A~input_o\)))
